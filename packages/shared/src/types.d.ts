...
export declare const DiffKind: {
    readonly FREE: 0;
    readonly PAID: 1;
    readonly MODERATED: 2;
    readonly REVERTED: 3;
};
export type DiffKind = (typeof DiffKind)[keyof typeof DiffKind];
export declare function isDiffKind(k: number): k is DiffKind;
...
export declare const ErrorCode: {
    ...
    readonly INVALID_JOB: "INVALID_JOB";
    readonly TOO_MANY_PIXELS: "TOO_MANY_PIXELS";
    ...
    readonly CAS_STALE: "CAS_STALE";
    readonly SETTLING: "SETTLING";
    readonly FROZEN: "FROZEN";
    readonly RATE_LIMITED: "RATE_LIMITED";
    readonly SETTLEMENT_FAILED: "SETTLEMENT_FAILED";
    readonly TURNSTILE_FAILED: "TURNSTILE_FAILED";
    readonly COOLDOWN: "COOLDOWN";
    readonly NOT_BLANK: "NOT_BLANK";
};
